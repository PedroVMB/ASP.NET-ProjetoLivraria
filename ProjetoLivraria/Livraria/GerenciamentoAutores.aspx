    ...
    <div class="row" style="text-align: left">
        ...
        <table>
            <tr style="display: grid">
                ...
                <td>
                    <asp:TextBox ID="tbxCadastroNomeAutor" runat="server" CssClass="form-control" Height="35px" Width="400px"
                ...
                <td>
                    <asp:TextBox ID="tbxCadastroSobrenomeAutor" runat="server" CssClass="form-control" Height="35px" Width="400px"
                        oninput="capitalizeFirstLetter(this)"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                        ControlToValidate="tbxCadastroSobrenomeAutor" Style="color: red;" ErrorMessage="* Digite o sobrenome do autor."></asp:RequiredFieldValidator>
                </td>
                <td>
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidatorEmail" runat="server" ControlToValidate="tbxCadastroEmailAutor"
    ...
    <div class="row">
        ...
        <asp:GridView ID="gvGerenciamentoAutores" runat="server" Width="100%" AutoGenerateColumns="False" Font-Size="14px" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <EditItemTemplate>
                        <asp:TextBox ID="tbxEditNomeAutor" runat="server" CssClass="form-control" Height="35px" MaxLength="15" Text='<%# Eval("aut_nm_nome")
%>'></asp:TextBox>
                    </EditItemTemplate>
                    <HeaderTemplate>
                        <asp:Label ID="lblTextoNomeAutor" runat="server" Style="text-align: center; display: block;" Text="Nome"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField>
                    <EditItemTemplate>
                        <asp:TextBox ID="tbxEditSobrenomeAutor" runat="server" CssClass="form-control" Height="35px" MaxLength="45" Text='<%#
Eval("aut_nm_sobrenome") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <HeaderTemplate>
                        <asp:Label ID="lblTextoSobrenomeAutor" runat="server" Style="text-align: center; display: block;" Text="Sobrenome"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField>
                    <EditItemTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorEditEmail" runat="server" ControlToValidate="tbxEditEmailAutor"
                            Style="color: red;" ErrorMessage="* Digite o E-mail do autor."></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidatorEditEmail" runat="server" ControlToValidate="tbxEditEmailAutor"
                            ValidationExpression="^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$"
                            ErrorMessage="* O E-mail não é válido. Por favor, digite um E-mail válido."
                            Style="color: red;"></asp:RegularExpressionValidator>
                    </EditItemTemplate>
                    <HeaderTemplate>
                        <asp:Label ID="lblTextoEmailAutor" runat="server" Style="text-align: center; display: block;" Text="E-mail"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField>
                    <EditItemTemplate>
                        ...
                        <asp:Button ID="btnCancelar" runat="server" CommandName="Cancel" CssClass="btn btn-danger" Text="Cancelar" OnClientClick="return confirm('Tem certeza que deseja deletar?');" CausesValidation="false" />
                    </EditItemTemplate>
                    <HeaderTemplate>
